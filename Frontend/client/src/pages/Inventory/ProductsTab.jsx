...
export const ProductsTab = () => {
    ...
    const getSupplierName = (id) => {
        ...
        return match ? match.name : id; // fallback to ID if string/legacy
    };
                        ...
                        <tbody>
                            {filteredProducts.map((product) => (
                                ...
                                >
                                    ...
                                    <td className="text-gray-600">{getSupplierName(product.supplierId) || product.supplier || "-"}</td>
                                    <td>
                ...
                <div className="space-y-5">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select value={formData.supplierId} onChange={(e) => setFormData({ ...formData, supplierId: e.target.value })} className="nintendo-input">
